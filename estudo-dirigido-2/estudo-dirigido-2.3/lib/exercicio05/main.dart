...
void main() {
  ...
  Apresentavel pessoa3 = Professor('Carla', 38, 'POO', 2000);
  Apresentavel pessoa4 = Professor('Diego', 41, 'Banco de Dados', 1900);
  ...
  for (Apresentavel item in pessoas.obterItens()) {
    item.exibirDados();
  }
}